...
#ifndef INC_NFCWRITEBUFFER_H_
#define INC_NFCWRITEBUFFER_H_

#include <cstdint>
#include <WriteBufferInterface.h>

class NFCWriteBuffer : public ::EmbeddedProto::WriteBufferInterface
{
    //! Store a maximum of MAX_SIZE bytes in the buffer
    static constexpr uint32_t MAX_SIZE = 50;

  public:
    NFCWriteBuffer() = default;
    ~NFCWriteBuffer() override = default;
