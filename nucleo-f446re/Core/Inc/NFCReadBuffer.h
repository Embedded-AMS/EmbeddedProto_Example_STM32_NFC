...
#ifndef INC_NFCREADBUFFER_H_
#define INC_NFCTREADBUFFER_H_

#include <cstdint>
#include <ReadBufferInterface.h>

class NFCReadBuffer : public ::EmbeddedProto::ReadBufferInterface
{
  ...
  public:
    NFCReadBuffer();
    ~NFCReadBuffer() override = default;
